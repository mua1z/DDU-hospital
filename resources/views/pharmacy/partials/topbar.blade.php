<header class="bg-white shadow-sm p-4 lg:p-6">
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
        <div>
            <h1 class="text-2xl lg:text-3xl font-bold text-gray-800 animate-fade-in">@yield('page-title', 'Welcome, Pharmacist')</h1>
            <p class="text-gray-600 mt-1">DDU Clinic Management System - @yield('page-subtitle', 'Pharmacy Dashboard')</p>
        </div>
        
        <!-- Search Bar -->
        <div class="flex-1 mx-4 lg:mx-8 hidden lg:block mt-4 lg:mt-0">
            <form action="{{ route('global.search') }}" method="GET" class="relative">
                <input type="text" name="query" placeholder="Search inventory..." class="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-200 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors">
        ...
        <div class="flex items-center space-x-4 mt-4 lg:mt-0">
            ...
            <!-- Date Display -->
            <div class="hidden lg:block px-4 py-2 bg-red-50 rounded-lg">
