...
<div class="animate-slide-up">
    ...
    <div class="mb-6 flex justify-between items-center">
        <a href="{{ route('lab.upload-results') }}" class="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition flex items-center space-x-2">
        ...
        <div class="flex space-x-3">
            ...
            @endif
            <button onclick="window.print()" class="px-4 py-2 bg-lab-primary text-white rounded-lg hover:bg-purple-700 transition flex items-center space-x-2">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div class="bg-white rounded-xl shadow p-6">
            <h3 class="text-lg font-bold text-gray-800 mb-4 flex items-center">
                <i class="fas fa-user-circle text-lab-primary mr-2"></i>
                Patient Information
            </h3>
            <div class="space-y-3">
                <div>
