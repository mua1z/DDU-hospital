<header class="bg-white shadow-sm p-4 lg:p-6">
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
        <div>
            <h1 class="text-2xl lg:text-3xl font-bold text-gray-800 animate-fade-in">@yield('page-title', 'Welcome, Doctor')</h1>
        ...
        <div class="flex items-center space-x-4 mt-4 lg:mt-0">
            ...
            <div class="hidden md:flex items-center space-x-2 px-4 py-2 bg-green-50 rounded-lg">
                ...
                <span class="text-gray-700 font-medium">
                    <span class="text-green-600 font-bold">12</span> Patients Today
                </span>
            </div>
            ...
            <!-- Date Display -->
            <div class="hidden lg:block px-4 py-2 bg-green-50 rounded-lg">
