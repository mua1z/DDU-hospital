...
@section('title', 'Admin Dashboard - DDU Clinics')
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 animate-slide-up">
    ...
    <div class="bg-white rounded-xl shadow p-6 border-l-4 border-green-500">
        <div class="flex justify-between items-start">
            <div>
                <p class="text-xs font-semibold text-gray-500 uppercase">Total Doctors</p>
        ...
        <div class="mt-4 text-sm text-green-600">
            <span class="flex items-center"><i class="fas fa-check-circle mr-1"></i> Active Staff</span>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow p-6 border-l-4 border-blue-500">
        <div class="flex justify-between items-start">
            <div>
                <p class="text-xs font-semibold text-gray-500 uppercase">Lab Technicians</p>
    ...
    <div class="bg-white rounded-xl shadow p-6 border-l-4 border-red-500">
        <div class="flex justify-between items-start">
            <div>
                <p class="text-xs font-semibold text-gray-500 uppercase">Pharmacists</p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <a href="{{ route('admin.users.create') }}" class="bg-white rounded-xl shadow p-6 flex items-center space-x-4 hover:shadow-lg transition transform hover:-translate-y-1 cursor-pointer group">
            ...
            <div>
                ...
                <p class="text-gray-600 text-sm">Create a new system account</p>
            </div>
        </a>
        ...
        <a href="{{ route('admin.logs.index') }}" class="bg-white rounded-xl shadow p-6 flex items-center space-x-4 hover:shadow-lg transition transform hover:-translate-y-1 cursor-pointer group">
            ...
            <div>
                ...
                <p class="text-gray-600 text-sm">View recent system activity</p>
            </div>
        </a>
        ...
        <a href="{{ route('admin.settings.index') }}" class="bg-white rounded-xl shadow p-6 flex items-center space-x-4 hover:shadow-lg transition transform hover:-translate-y-1 cursor-pointer group">
            ...
            <div>
                ...
                <p class="text-gray-600 text-sm">Manage configuration</p>
            </div>
        </a>
    </div>
</div>
...
<div class="animate-slide-up" style="animation-delay: 0.2s">
    <div class="flex justify-between items-center mb-4">
        <h2 class="text-xl font-bold text-gray-800">Recently Added Users</h2>
        <a href="{{ route('admin.users.index') }}" class="text-purple-600 hover:underline font-medium">View All</a>
    </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                <thead class="bg-purple-50">
                    <tr>
                        <th class="py-3 px-4 text-left text-gray-700 font-semibold">Activity</th>
                        <th class="py-3 px-4 text-left text-gray-700 font-semibold">User Name</th>
                        <th class="py-3 px-4 text-left text-gray-700 font-semibold">Role</th>
                        <th class="py-3 px-4 text-left text-gray-700 font-semibold">Joined</th>
                    </tr>
                </thead>
                <tbody>
                    @forelse($recent_users as $user)
                    <tr class="border-b hover:bg-gray-50 transition">
                        <td class="py-4 px-4"><span class="flex items-center text-gray-600"><i class="fas fa-user-plus text-purple-500 mr-2"></i> New Account Created</span></td>
                    ...
                    @empty
                    <tr>
                        <td colspan="4" class="py-8 text-center text-gray-500">No recent activity found.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
