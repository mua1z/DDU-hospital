...
<head>
    ...
    <title>@yield('title', 'DDU Clinic - Patient Portal')</title>
    ...
    <script>
        tailwind.config = {
            theme: {
                extend: {
                    colors: {
                        'ddu-primary': '#2563EB', /* Blue theme for patients */
    ...
    <div class="flex h-screen">
        ...
        <main class="flex-1 overflow-y-auto bg-gray-50/50">
            ...
            <div class="p-4 lg:p-6 pb-20">
                ...
                <div x-data="{ show: true }" x-show="show" class="bg-green-100 border-l-4 border-green-500 text-green-700 p-4 mb-6 shadow relative rounded-md animate-fade-in" role="alert">
                ...
                @if(session('error'))
                <div x-data="{ show: true }" x-show="show" class="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 mb-6 shadow relative rounded-md animate-fade-in" role="alert">
                    <div class="flex justify-between items-start">
                        <div>
